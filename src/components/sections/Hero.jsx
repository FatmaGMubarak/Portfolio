...
<div className='bg-customPink1 w-52 h-52 lg:w-72 lg:h-72 rounded-full relative'></div>
                    <div className='bg-customBlue5 w-44 h-44 lg:w-64 lg:h-64 rounded-full absolute'><img src={avatar} alt="" className='w-52 lg:w-80 absolute z-20' style={{ clipPath: "circle(50% at 50% 50%)" }}/>
</div>
                    </div>
...
{Array.from({ length: 9 }).map((_, i) => (
  <div
    key={i}
    className=" absolute bg-[#ffd60a] hover:bg-yellow-200- w-1 h-32 bottom-0 origin-bottom transform animate-pulse "
    style={{
  ...
  ></div>
        ...
        <div className='p-10 flex justify-evenly items-center w-full lg:w-[30%] mt-0 lg:-mt-28'>
            <a href='/Fatma.pdf' target='_blank' className=" text-gray-800 bg-customBlue5 hover:bg-customBlue1 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Resume</a>
